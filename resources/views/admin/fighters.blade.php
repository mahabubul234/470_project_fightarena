          ...
          <div class="main-panel">
            ...
            @endif
              <div class="div_centre">
                <h1 class="font_size">Add Fighter</h1>
                <form action="{{url('/add_fighters')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="div_design">
                    ...
                    <input type="submit" value="Add Fighter" class="btn btn-primary">
                </div>
                </form>
